        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container">
                    <Link className="navbar-brand" to="/">STANDGATES</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><Link className="dropdown-item" to={`/TermsCondition/`}> Terms & Conditions</Link></li>
                                    <li><Link className="dropdown-item" to={`/CookiePolicy/`}> Cookie Policy</Link></li>
                        ...
                        {isLoggedIn()
                            ?
                            <>
                                <Link className="btn btn-primary me-2" to={'/customer/account/'}>{userProfile?.full_name}</Link>
